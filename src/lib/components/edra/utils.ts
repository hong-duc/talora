...
/**
 * Mock upload function for development - logs debug and returns mock URL
 * @param file - File object to "upload"
 * @returns Promise<string> - Mock URL
 */
export const mockImageUpload = async (file: File): Promise<string> => {
	console.log('Image upload mock:', file);
	// Simulate async upload with delay
	await new Promise(resolve => setTimeout(resolve, 300));
	// Return mock URL as specified
	return 'https://nhxitjtfdhmrqrcoemjo.supabase.co/storage/v1/object/public/images/test/%20-2.jpg';
};
